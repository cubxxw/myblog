        ...
        $this->start_controls_section(
            ...
            $this->start_controls_tabs('notify_content_style_tabs');
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        'info_button_svg_color',
                        [
                            'label' => __( 'SVG Icon Color', 'htmega-addons' ),
                            'type' => Controls_Manager::COLOR,
                            'default' =>'#444444',
                            'selectors' => [
        ...
        ?>
            <div <?php echo $this->get_render_attribute_string('notify_attr'); ?> >
                ...
                <div class="htmega-notify-alert-<?php echo $id;?>">
                    <button class="htmega-notify-button show-info-<?php echo $id;?> alert-<?php echo $notify_options['type']; ?>"><?php echo esc_html__( $settings['notification_button_txt'],'htmega-addons' );?></button>
                </div>
