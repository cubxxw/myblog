    ...
    protected function render( $instance = [] ) {
        ...
        ?>
            <div <?php echo $this->get_render_attribute_string( 'htmega_post_slider_attr' ); ?>>
                ...
                ?>
                    <div <?php echo $this->get_render_attribute_string( 'htmega_post_slider_item_attr' ); ?> data-title="<?php echo wp_trim_words( get_the_title(), 10, '' ); ?>" data-thumbnail="<?php  if( 'thumb' == $dot_style ){ echo the_post_thumbnail_url(); }else { echo '';} ?>" >
                        ...
                        <?php if( $settings['post_slider_layout'] == 2 ): ?>
                            ...
                            <?php elseif ( $settings['post_slider_layout'] == 6 || $settings['post_slider_layout'] == 7 ): ?>
                                ...
                                <div class="htmega-post-slider-st-6 <?php if( $settings['post_slider_layout'] == 7 ){ echo " htmega-post-slider-st-7"; } ?>">
