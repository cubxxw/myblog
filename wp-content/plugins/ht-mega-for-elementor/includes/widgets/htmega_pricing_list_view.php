                    ...
                    <tbody>
                        <?php for( $i = 0; $i < count( $table_tr ); $i++ ) : ?>
                            <tr>
                                ...
                                ?>
                                <td <?php echo $this->get_render_attribute_string( $pricing_table_repeater_key ); ?> <?php echo $table_td[$j]['colspan'] > 1 ? ' colspan="'.$table_td[$j]['colspan'].'"' : ''; ?>>
                                    <?php
                                            ...
                                            <?php }elseif( $table_td[$j]['contenttype'] == 'text' ){ ?>
                                                <div class="htmega-pricing-table__head-row-cell-area">
                                                    <?php if( !empty( $table_td[$j]['link_url'] ) ){
                                                        ...
                                                        <span class="table-row-title"><?= $table_td[$j]['title']; ?></span>
                                                        <?php if(!empty($table_td[$j]['celllable'])){ ?>
                                                            <span class="ht-data-label"><?= $table_td[$j]['celllable']; ?></span>
                                                        <?php } ?>
                                                    <?php } ?>
                                                </div>
                                            ...
                                            <?php 
                                                ...
                                                if( !empty( $table_td[$j]['contenttype'] == 'button' && !empty($table_td[$j]['title']) ) ){ ?>
                                                    <div class="htmega-pricing-table__head-row-cell-area htmega-button">
                                                        <a class="htb-btn" href="<?php echo esc_url( $table_td[$j]['link_url'] ); ?>" <?php echo $table_td[$j]['link_target']; ?> <?php echo $table_td[$j]['nofollow']; ?> >
