            ...
            $this->add_control(
                ...
                [
                    ...
                    'selectors' => [
                        ...
                        '{{WRAPPER}} .htmega-service-style-7:hover .icon svg' => 'fill: {{VALUE}}!important;',
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'selectors' => [
                                ...
                                '{{WRAPPER}} .htmega-service .icon svg' => 'fill: {{VALUE}};',
                            ],
                        ]
                    );
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'selectors' => [
                                ...
                                '{{WRAPPER}} .htmega-service:hover .icon svg' => 'fill: {{VALUE}};',
                            ],
                        ]
                    );
