    ...
    protected function render( $instance = [] ) {
        ...
        ?>
            ...
            if( 'top' == $post_content_position ){
                ...
                <?php 
                echo "<style>
                .{$sectionid}.htmega-single-post-style-1 .content {
                    bottom: auto;
                    top: 0;
                } 
                </style>
                ...
                ?>
                <script>
                    var marginLeft = jQuery(".<?php echo $sectionid;?>.htmega-single-post-style-1 .content").css("margin-left");
                    var marginRight = jQuery(".<?php echo $sectionid;?>.htmega-single-post-style-1 .content").css("margin-right");
                    ...
                    if( marginLeft2 || marginRight2 ){
                        ...
                        jQuery(".<?php echo $sectionid;?>.htmega-single-post-style-1 .content").css("width", calcevalue);
                    }
                </script>
            <?php
            }
