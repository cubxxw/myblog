    ...
    protected function render( $instance = [] ) {
        ...
        ?>
            <div <?php echo $this->get_render_attribute_string( 'team_area_attr' ); ?> >
                                ...
                                <div class="htmega-hover-action">
                                    <div class="htmega-hover-content-box-st2">
                                        ...
                                        if( !empty($settings['htmega_member_name']) ){
                                            echo '<h4 class="htmega-team-name">'.esc_html( $settings['htmega_member_name'] ).'</h4>';
                                        }
                ...
                <?php if( 'no'== $settings['show_img_animation']){
                    echo "<style> .{$sectionid}.htmega-team-style-7:hover .htmega-thumb img,.{$sectionid}.htmega-team-style-6:hover .htmega-thumb img {
