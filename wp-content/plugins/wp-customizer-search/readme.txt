...
1. Upload the plugin files to the `/wp-content/plugins/wp-customizer-search` directory, or install the plugin through the WordPress plugins screen directly.
...
= 1.1.3 =
- Setup plugin translations through https://translate.wordpress.org/projects/wp-plugins/wp-customizer-search/.
